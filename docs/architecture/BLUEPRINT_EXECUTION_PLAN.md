...
> **تحديث:** الموجات 1–3 (A1، A2، A3، B1، B2، B3، C1، C2) **نُفِّذت فعليًّا** ومربوطة بالموقع.
> راجع [حالة التنفيذ](./BLUEPRINT_IMPLEMENTATION_STATUS.md). الموجة 4 (D1–D3) تنتظر موافقة/مُدخلًا.
