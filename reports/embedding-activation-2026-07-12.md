...
القياس النهائي المباشر من Neon (workflow قراءة-فقط، بعد إصلاح 429، 2026-07-14):

| النوع | الكوربوس | لها متجه | التغطية |
|---|---|---|---|
| المواد | 17,323 | 17,323 | **100%** ✅ |
| المبادئ | 4,066 | 4,066 | **100%** ✅ |
| الأحكام | 51,105 | **50,273** | **98.4%** ✅ |
| **الإجمالي** | — | **71,662 متجهًا** | — |

> رحلة تغطية الأحكام: 8.5% → 49% (أول تشغيل) → **98.4%** (بعد إصلاح إعادة المحاولة عند 429). تبقّى 832 حكمًا (429 مستمرّ بعد كل المحاولات) — قابلة للإكمال بإعادة تشغيل في وقت أهدأ لحدّ المعدّل.
