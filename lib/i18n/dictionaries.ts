...
const ar: Dict = {
  ...
  "nav.ask": "اسأل حكيم",
  "nav.workspace": "مساحة العمل المتقدمة",
  ...
  "nav.platformAdmin": "إدارة المنصة",
  ...
  "topbar.askPlaceholder": "اسأل حكيم عن مسألة قانونية",
  "topbar.search": "بحث",
  "topbar.ask": "اسأل حكيم",
...
const en: Dict = {
  ...
  "nav.ask": "Ask Hakeem",
  "nav.workspace": "Advanced workspace",
  ...
  "nav.myFiles": "My Space",
  "topbar.searchPlaceholder": "Search statutes, articles and judgments...",
  "topbar.askPlaceholder": "Ask Hakeem about a legal matter",
  "topbar.search": "Search",
  "topbar.ask": "Ask Hakeem",
