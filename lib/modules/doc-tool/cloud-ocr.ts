 ...
 *  رُفِع إلى 12: مع الفوترة (بلا حدّ معدّلٍ مجانيّ) يُشبع المفتاح المدفوع مباشرةً؛
 *  والجدولة المتكيّفة تتراجع تلقائيًّا عند 429 فلا يضرّ المفاتيح المجانية. */
 ...
 *  الترميز إلى JPEG وقبل انتظار الشبكة (encodeToFit ثمّ canvas.width=0 قبل postToCloud)،
 *  فأثناء نداء Gemini — وهو الجزء البطيء — لا يبقى في الذاكرة إلا blob صغير (~300ك)
 *  لا الـ canvas. لذا زيادة التوازي تُشبع مفتاحًا مدفوعًا (RPM عالٍ) بلا ضغط ذاكرةٍ
 *  حقيقيّ. الجدولة المتكيّفة تتراجع عند 429 (المفاتيح المجانية) فتبقى آمنة. */
