 ...
 *  رُفِع إلى 8: المفاتيح المدفوعة تحتمل توازيًا أعلى، والجدولة المتكيّفة تتراجع
 *  تلقائيًّا عند 429 فلا يضرّ المفاتيح المجانية — صافي الأثر: تفريغٌ أسرع للمستندات. */
