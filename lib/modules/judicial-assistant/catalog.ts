...
export const SERVICES: ServiceDef[] = [
  ...
  { id: "JS-009", title: "حساب المدد", review: "mandatory", iconKey: "deadline", available: false },
  { id: "JS-010", title: "مصفوفة الإثبات", review: "mandatory", iconKey: "evidence", available: false },
