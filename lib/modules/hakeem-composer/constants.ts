...
export const COMPOSER_SOURCES: Array<{
  ...
  {
    id: "legal-core",
    label: "مكتبة الأنظمة (+ المرفق الحالي إن وُجد)",
    description: "النواة النظامية؛ والمرفق المرفوع يُقرأ كسياق إن وُجد",
    hint: "ابحث في الأنظمة الموثّقة. إن أرفقت مستندًا فسيُقرأ كسياق مع الطلب.",
  },
  {
    id: "regulations",
    label: "اللوائح (+ المرفق الحالي إن وُجد)",
    description: "اللوائح التنفيذية والتنظيمية",
    hint: "راعِ اللوائح ذات الصلة. المرفق الحالي يُقرأ إن وُجد.",
  },
  {
    id: "rulings-principles",
    label: "الأحكام والمبادئ (+ المرفق الحالي إن وُجد)",
    description: "سوابق ومبادئ للاستئناس",
    hint: "استأنس بالأحكام والمبادئ مع تمييزها عن السند النظامي. المرفق الحالي يُقرأ إن وُجد.",
  },
  {
    id: "attached-only",
    label: "المرفقات فقط",
    description: "حصر الاعتماد على الملفات المرفقة — بلا بحث في المكتبة",
    hint: "اعتمد على المستندات المرفقة فقط دون البحث في مكتبة الأنظمة أو الويب.",
  },
  {
    id: "user-docs",
    label: "مستندات المستخدم",
    description: "ملفاتك المرفقة في هذا الطلب",
    hint: "فضّل مستندات المستخدم المرفقة في هذا الطلب.",
  },
  {
    id: "case-files",
    label: "ملفات القضية",
    description: "يتطلّب سياق قضية مصرّحًا من الخادم",
    hint: "يُرفض أو يُفعَّل فقط عند وجود قضية مربوطة ومملوكة (قرار خادمي).",
  },
];
