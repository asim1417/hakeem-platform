...
const GREETING = [
  "السلام عليكم", "سلام عليكم", "وعليكم السلام", "السلام", "مرحبا", "اهلا", "اهلين", "اهلن", "هلا", "هلو", "هاي",
  "صباح الخير", "مساء الخير", "صباح النور", "مساء النور", "تحيه طيبه", "حياك", "حياكم", "يعطيك العافيه", "كيف حالك", "كيفك",
];
