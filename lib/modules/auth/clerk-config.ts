...
export const clerkLocalization: LocalizationResource = {
  ...
  signIn: {
    ...
    start: {
      ...
      subtitle: "ادخل عبر Google أو Apple أو Microsoft",
      subtitleCombined: "ادخل عبر Google أو Apple أو Microsoft",
  ...
  signUp: {
    ...
    start: {
      ...
      subtitle: "أنشئ حسابك عبر Google أو Apple أو Microsoft",
...
function buildClerkAppearance() {
  ...
  return {
    ...
    elements: {
      ...
      // إخفاء مسار البريد/اسم المستخدم من شاشة البداية — الدخول عبر SSO فقط.
      dividerRow: "auth-clerk-hide-email-path",
      formFieldRow__identifier: "auth-clerk-hide-email-path",
      formFieldRow__emailAddress: "auth-clerk-hide-email-path",
      formFieldRow__emailAddress_username: "auth-clerk-hide-email-path",
      formFieldRow__username: "auth-clerk-hide-email-path",
      formButtonPrimary:
