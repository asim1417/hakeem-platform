...
export const CONCEPT_ENTRIES: ConceptEntry[] = [
  ...
  {
    triggers: ["الفصل التعسفي", "فصل التعسفي", "فصل تعسفي", "طرد من العمل", "فصل العامل", "إنهاء عقد العمل", "إنهاء خدمة", "مكافأة نهاية الخدمة", "نهاية الخدمة", "مكافأة الخدمة", "أجر العامل", "ساعات العمل", "الإجازة السنوية"],
