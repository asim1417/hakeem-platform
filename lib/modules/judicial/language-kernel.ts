...
/**
 * عبارات الحسم الحصريّة بصوت المحكمة (الفاعل = الدائرة/المحكمة) — يمنع ورودها في مذكّرة
 * طرفٍ أو بحثٍ (JG13). تُقصر على صيغة الإصدار (فاعلٌ قضائيّ + فعل قضاء)، لا على أسماء
 * النتائج المجرّدة مثل «عدم القبول» أو «صرف النظر» — فتلك يطلبها/يدفع بها الطرف مشروعًا.
 */
