...
const SEGMENT_LABELS: Array<{ prefix: string; label: string }> = [
  ...
  { prefix: "/dashboard/legal-core", label: "المكتبة النظامية" },
  ...
  { prefix: "/dashboard/files", label: "مساحتي" },
  ...
  { prefix: "/dashboard", label: "الصفحة الرئيسية" },
  ...
  { prefix: "/admin", label: "إدارة المنصة" },
  ...
  { prefix: "/onboarding", label: "ملفي المهني" },
];
