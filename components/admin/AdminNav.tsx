...
const SUPER_LINKS = [
  ...
  { href: "/admin/billing/plans", label: "الخطط والأسعار" },
  { href: "/admin/billing/service-rates", label: "أسعار الخدمات" },
  { href: "/admin/billing/profitability", label: "ربحية الخدمات" },
  { href: "/admin/billing/payments", label: "المدفوعات" },
  { href: "/admin/billing/users", label: "محافظ المستخدمين" },
  { href: "/admin/usage", label: "الاستهلاك" },
  { href: "/admin/usage/week", label: "رصد الأسبوع" },
  ...
  { href: "/admin/governance", label: "الحوكمة المعمارية" },
