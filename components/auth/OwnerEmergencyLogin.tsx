...
/** دخول طوارئ للمالك — يعمل بلا مفاتيح Clerk. */
export function OwnerEmergencyLogin({ nextUrl = "/dashboard" }: { nextUrl?: string }) {
    ...
    <div className="w-full space-y-4 rounded-[var(--r-md)] border border-[var(--gold-border)] bg-[var(--gold-ghost)] p-4">
      <div>
        ...
        <p className="mt-1 text-xs leading-6 text-[var(--ink-60)]">
          يعمل الآن بلا Clerk. بعد ضبط مفاتيح Clerk استخدم نموذج Clerk أعلاه.
        </p>
      </div>
