...
const FEATURES = [
  ...
  { ic: ScanIcon, t: "قراءة ضوئية", d: "الصور والوثائق الممسوحة ضوئياً تُقرأ عربياً داخل متصفحك — الصورة لا تُرفع لأي خادم أثناء القراءة المحلية." },
  { ic: DriveIcon, t: "استيراد من Drive", d: "اربط حساب التخزين السحابي واستورد مستنداتك مباشرةً عند تهيئة المنصة — قراءة فقط للملفات التي تختارها." },
  { ic: TagIcon, t: "تصنيف وترميز آلي", d: "نوع الوثيقة والجهة المُصدِرة والسنة، ورمز أرشيفي قابل للمراجعة وفق مرجع تشغيلي." },
  { ic: SearchIcon, t: "بحث بمستوى المحترفين", d: "عبارة دقيقة، استبعاد، «أو»، اشتقاق صرفي، وترتيب بالصلة مع تنقّل بين المطابقات." },
  ...
  { ic: SaveIcon, t: "قضاياك محفوظة", d: "احفظ مجموعة الوثائق بملاحظاتها في حسابك وافتحها لاحقاً — أو صدّرها نسخة مقفلة مشفّرة." },
