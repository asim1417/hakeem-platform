...
const PRIVACY = [
  ...
  { ic: LockIcon, t: "النسخة المقفلة تُشفَّر على جهازك بمعيار AES-GCM (مفتاح مشتق بكلمة مرورك، PBKDF2 ×150 ألف) قبل أن تُنزَّل." },
  { ic: ScanIcon, t: "الوثائق الممسوحة ضوئياً (صور بلا نص) تُكتشف ويُطلب لها OCR خارجي — لا نُخمّن نصاً غير موجود." }
];
