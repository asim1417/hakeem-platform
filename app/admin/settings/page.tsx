  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-8">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-[#0B1F3A]">إعدادات المنصّة</h1>
      ...
      <p className="mt-6 rounded-md border border-[#C09B5A]/25 bg-[#FBF8F1] p-4 text-xs leading-6 text-[#0B1F3A]/70">
