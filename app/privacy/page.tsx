...
const sections: Array<{ h: string; p: string[] }> = [
  ...
  },
  {
    ...
    p: [
      ...
      "بيانات الدخول: عبر مزوّد المصادقة (Clerk و/أو Google OAuth) — البريد والاسم المعروضان من المزوّد.",
      "المستندات المرفوعة: تُعالَج لتقديم الخدمة؛ وقد تُرسَل مقتطفات غير معرّفة إلى مزوّد الذكاء الاصطناعي عند تفعيل التحليل.",
      "لا تُرسَل بياناتك الشخصية (البريد، رقم الجوال، معرّف الحساب) إلى مزوّدات الذكاء الاصطناعي عمدًا؛ تُطبَّق تنقية قبل الإرسال حيثما وُجد المسار.",
      "للتواصل بشأن حقوق البيانات: عبر قنوات الدعم داخل المنصة أو البريد المعلن في صفحة التواصل عند توفره.",
    ],
  },
  {
    h: "٣) أغراض المعالجة",
    p: [
      ...
      "تحسين جودة الاسترجاع والبحث (عبر سجلات بحث مجهّلة قدر الإمكان).",
    ],
  },
  {
