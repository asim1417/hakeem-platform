...
const sections: Array<{ h: string; p: string[] }> = [
  ...
  },
  {
    ...
    p: [
      "واجهة «أمان الامتثال» داخل ChatGPT مخصّصة لفرز المجال القانوني العام ومستوى الاستعجال وقناة التواصل التي يختارها المستخدم. لا تطلب الأداة أسماء الخصوم أو أرقام الهوية أو أرقام القضايا أو المستندات، ولا تحفظ تلك التصنيفات في قاعدة بيانات المنصّة.",
      "لا يُنشأ طلب استشارة لدى أمان ولا يُرسل نص المحادثة أو أي ملف إلى الشركة من خلال هذه الواجهة. لا ينتقل المستخدم إلى موقع أمان أو واتساب إلا إذا اختار الرابط بنفسه.",
      "تبقى محادثتك مع ChatGPT ومعالجة الاتصال الفني خاضعة أيضاً لسياسات ChatGPT/OpenAI ومشغّل الاستضافة. لا تشارك بيانات شخصية أو وقائع حساسة في حقل الفرز.",
    ],
  },
  {
    h: "٤) أغراض المعالجة",
