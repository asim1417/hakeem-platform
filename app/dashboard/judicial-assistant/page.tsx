  ...
  return (
    <div className="ja">
      ...
      <LegalAlert tone="info">
        هذه النسخة الأولى تقدّم مساحة القضية والملخّص التنفيذيّ المؤصَّل (JS-001) حيًّا. بقيّة الأعمال (الاختصاص، الإثبات،
        التسبيب، مشروع الحكم، الاعتراض…) معروضةٌ كمقترحاتٍ على خارطة الطريق وتُفعَّل تِباعًا وفق المواصفة.
      </LegalAlert>
    </div>
  );
}
